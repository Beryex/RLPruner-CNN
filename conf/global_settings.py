...
RL_GREEDY_EPSILON = 0.2

RL_MAX_SAMPLE_STEP = 2
RL_MAX_GENERATE_NUM = 4
RL_GENERATE_NUM_SCALING_FACTOR = 1
...
T_FT_LR_SCHEDULAR_INITIAL_LR = 1e-2
...
C_COMPRESSION_EPOCH = 25
C_DEV_NUM = 25
C_FT_EPOCH = 100

C_SINGLE_STEP_ACCURACY_CHANGE_THRESHOLD = 0.1
C_SINGLE_STEP_ACCURACY_CHANGE_THRESHOLD_INCRE = 0.02
C_OVERALL_ACCURACY_CHANGE_THRESHOLD = 0.01

C_WEIGHT_SHARING_SCALING_FACTOR = 2

C_PRUNE_FILTER_MAX_RATIO = 0.08
C_PRUNE_FILTER_MIN_RATIO = 0.03
