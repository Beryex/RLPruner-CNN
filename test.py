...
from utils import setup_logging, get_dataloader, count_custom_conv2d, count_custom_linear
...
def test():
    ...
    logging.info(f'Compressed model has FLOPs: {top1_acc}, Parameter Num: {top5_acc}')
