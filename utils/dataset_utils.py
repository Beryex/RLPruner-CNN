...
def get_dataloader(dataset: str, 
    ...
    if dataset == 'mnist':
        ...
        mnist_training_loader = DataLoader(mnist_training, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size, pin_memory=pin_memory)
        ...
        mnist_prototyping_loader = DataLoader(mnist_prototyping, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size, pin_memory=pin_memory)
        ...
        cifar10_training_loader = DataLoader(cifar10_training, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size, pin_memory=pin_memory)
        ...
        cifar10_prototyping_loader = DataLoader(cifar10_prototyping, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size, pin_memory=pin_memory)
        ...
        cifar100_training_loader = DataLoader(cifar100_training, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size, pin_memory=pin_memory)
        ...
        cifar100_prototyping_loader = DataLoader(cifar100_prototyping, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size, pin_memory=pin_memory)
